        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdopterName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "AdoptionEntries",
                columns: table => new
                {
                    AdoptionEntryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PetId = table.Column<int>(type: "int", nullable: false),
                    AdopterId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdoptionEntries", x => x.AdoptionEntryId);
                    table.ForeignKey(
                        name: "FK_AdoptionEntries_Adopters_AdopterId",
                        column: x => x.AdopterId,
                        principalTable: "Adopters",
                        principalColumn: "AdopterId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdoptionEntries_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdoptionEntries_AdopterId",
                table: "AdoptionEntries",
                column: "AdopterId");

            migrationBuilder.CreateIndex(
                name: "IX_AdoptionEntries_PetId",
                table: "AdoptionEntries",
                column: "PetId");
